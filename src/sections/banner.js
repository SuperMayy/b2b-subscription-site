...
import bannerImage from 'assets/app-pic.png';
  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Heading as="h2">The easiest way to set up your business phone</Heading>
        <Heading as="h3">Communicate with customers from all over the world with our easy to use software. Get unlimited calls, messages, and meetings on any device.</Heading>
        <Link
          path="/signup"
          ml={2}
